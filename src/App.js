...
var App = function () {
  var _a = (0, react_1.useState)("Library"),
    tab = _a[0],
    setTab = _a[1];
  var renderScreen = function () {
    switch (tab) {
      case "Library":
        return <LibraryScreen_1.default />;
      case "Queue":
        return <QueueScreen_1.default />;
      case "Playlists":
        return <PlaylistsScreen_1.default />;
    }
  };
  return (
        ...
        <QueueContext_1.QueueProvider>
          <react_native_1.View style={{ flex: 1, backgroundColor: "#000" }}>
            <react_native_1.View style={styles.tabBar}>
              {["Library", "Queue", "Playlists"].map(function (t) {
                return (
